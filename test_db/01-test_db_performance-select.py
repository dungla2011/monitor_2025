...
- Mỗi thread query 1 hàng cứ 1 phút/lần
    ...
    try:
        while not shutdown_event.is_set():
            ...
            try:
                ...
                cursor.execute(
                    "SELECT id, name, url_check, enable FROM monitor_items WHERE id = %s",
                    (item_id,)
                )
                result = cursor.fetchone()
...
def main():
    ...
    console_logger.info("🚀 Starting Database Performance Test")
    ...
    try:
        ...
        console_logger.info("✅ Database Performance Test completed")
